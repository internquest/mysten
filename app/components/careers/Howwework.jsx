                            ...
                            <div class="box-border [-webkit-font-smoothing:inherit] flex-[0_0_auto] h-[24px] relative w-[24px] opacity-100 transform-none">
                                <div class="box-border [-webkit-font-smoothing:inherit] contents">
                                    <svg
                                        ...
                                        <line x1="7" y1="17" x2="17" y2="7" class="box-border [-webkit-font-smoothing:inherit]"></line>
                                        <polyline points="7 7 17 7 17 17" class="box-border [-webkit-font-smoothing:inherit]"></polyline>
                                    </svg>
                                </div>
                            </div>
                        </a>
                ...
                <div data-framer-name="cards" name="cards" class="box-border t1199:gap-6 t1199:w-full [-webkit-font-smoothing:inherit] items-start flex flex-[1_0_0px] [flex-flow:column] gap-[50px] h-min overflow-visible p-0 relative w-px">
                    <div data-framer-name="card" name="card" class="box-border [-webkit-font-smoothing:inherit] items-start flex flex-[0_0_auto] [flex-flow:column] gap-0 h-min overflow-visible p-0 relative w-full opacity-100 transform-none">
                        <div data-framer-name="top" name="top" class="box-border [-webkit-font-smoothing:inherit] items-start flex flex-[0_0_auto] [flex-flow:row] gap-0 h-[103px] overflow-visible pl-0 pr-[76px] py-0 relative w-full">
                            ...
                            <div data-framer-component-type="SVG" data-framer-name="shape" name="shape" aria-hidden="true" class="box-border [-webkit-font-smoothing:inherit] relative flex-[0_0_auto] h-[103px] w-[60px] flex-shrink-0 fill-[rgb(0,_0,_0)] text-[rgb(0,_0,_0)]">
                                <div class="box-border [-webkit-font-smoothing:inherit] w-full h-full [aspect-ratio:inherit]">
                                    <svg viewBox="0 0 60 103" preserveAspectRatio="none" width="100%" height="100%" class="box-border [-webkit-font-smoothing:inherit] block w-full h-full">
                                        <use href="#svg-1426629872_222" class="box-border [-webkit-font-smoothing:inherit]"></use>
                                    </svg>
                                </div>
                            </div>
                        </div>
                        ...
                        <div data-framer-name="Icon" name="Icon" class="box-border [-webkit-font-smoothing:inherit] bg-[rgb(254,_229,_234)] rounded-[15px] flex-[0_0_auto] h-[72px] overflow-hidden absolute right-0 top-0 w-[72px]">
                            <div data-framer-name="Icons" name="Icons" class="box-border [-webkit-font-smoothing:inherit] flex-[0_0_auto] h-[30px] left-[calc(49.9974% - 14.8966px)] overflow-hidden absolute top-[calc(50% - 14.8966px)] w-[30px]">
                                <div data-framer-component-type="SVG" data-framer-name="Vector" name="Vector" aria-hidden="true" class="box-border [-webkit-font-smoothing:inherit] absolute flex-[0_0_auto] h-[23px] left-[calc(50% - 11px)] top-[calc(50% - 11.25px)] w-[22px] flex-shrink-0 fill-[rgb(0,_0,_0)] text-[rgb(0,_0,_0)]">
                                    <div class="box-border [-webkit-font-smoothing:inherit] w-full h-full [aspect-ratio:inherit]">
                                        <svg viewBox="0 0 28 28" preserveAspectRatio="none" width="100%" height="100%" class="box-border [-webkit-font-smoothing:inherit] block w-full h-full">
                                            <use href="#svg-1965679041_960" class="box-border [-webkit-font-smoothing:inherit]"></use>
                                        </svg>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div data-framer-name="card" name="card" class="box-border [-webkit-font-smoothing:inherit] items-start flex flex-[0_0_auto] [flex-flow:column] gap-0 h-min overflow-visible p-0 relative w-full opacity-100 transform-none">
                        ...
                        <div data-framer-name="Icon" name="Icon" class="box-border [-webkit-font-smoothing:inherit] bg-[rgb(254,_229,_234)] rounded-[15px] flex-[0_0_auto] h-[72px] overflow-hidden absolute right-0 top-0 w-[72px]">
                            <div data-framer-name="Icons" name="Icons" class="box-border [-webkit-font-smoothing:inherit] flex-[0_0_auto] h-[30px] left-[calc(50% - 15px)] overflow-hidden absolute top-[calc(50% - 14.75px)] w-[30px]">
                                <div data-framer-component-type="SVG" data-framer-name="Vector" name="Vector" aria-hidden="true" class="box-border [-webkit-font-smoothing:inherit] absolute flex-[0_0_auto] h-[22px] left-[calc(50% - 12.25px)] top-[calc(50% - 11px)] w-[25px] flex-shrink-0 fill-[rgb(0,_0,_0)] text-[rgb(0,_0,_0)]">
                                    <div class="box-border [-webkit-font-smoothing:inherit] w-full h-full [aspect-ratio:inherit]">
                                        <svg viewBox="0 0 30 28" preserveAspectRatio="none" width="100%" height="100%" class="box-border [-webkit-font-smoothing:inherit] block w-full h-full">
                                            <use href="#svg1423660437_702" class="box-border [-webkit-font-smoothing:inherit]"></use>
                                        </svg>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div data-framer-name="Icon" name="Icon" class="box-border [-webkit-font-smoothing:inherit] bg-[rgb(254,_229,_234)] rounded-[15px] flex-[0_0_auto] h-[72px] overflow-hidden absolute right-0 top-0 w-[72px]">
                            <div data-framer-name="Icons" name="Icons" class="box-border [-webkit-font-smoothing:inherit] flex-[0_0_auto] h-[30px] left-[calc(50% - 15px)] overflow-hidden absolute top-[calc(50% - 14.75px)] w-[30px]">
                                <div data-framer-component-type="SVG" data-framer-name="Vector" name="Vector" aria-hidden="true" class="box-border [-webkit-font-smoothing:inherit] absolute flex-[0_0_auto] h-[22px] left-[calc(50% - 12.25px)] top-[calc(50% - 11px)] w-[25px] flex-shrink-0 fill-[rgb(0,_0,_0)] text-[rgb(0,_0,_0)]">
                                    <div class="box-border [-webkit-font-smoothing:inherit] w-full h-full [aspect-ratio:inherit]">
                                        <svg viewBox="0 0 30 28" preserveAspectRatio="none" width="100%" height="100%" class="box-border [-webkit-font-smoothing:inherit] block w-full h-full">
                                            <use href="#svg2003137687_1099" class="box-border [-webkit-font-smoothing:inherit]"></use>
                                        </svg>
                                    </div>
                                </div>
                            </div>
